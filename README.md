...
*   [Overview](#step2)
*   [Objectives](#step3)
*   [Setup and requirements](#step4)
*   [Multi-Agent Systems](#step5)
*   [Task 1. Install ADK and set up your environment](#step6)
*   [Task 2. Explore transfers between parent, sub-agent, and peer agents](#step7)
*   [Task 3. Use session state to store and retrieve specific information](#step8)
*   [Workflow Agents](#step9)
*   [Task 4. Begin building a multi-agent system with a SequentialAgent](#step10)
*   [Task 5. Add a LoopAgent for iterative work](#step11)
*   [Task 6. Use a "fan out and gather" pattern for report generation with a ParallelAgent](#step12)
*   [Custom workflow agents](#step13)
